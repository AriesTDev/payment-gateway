...
namespace Aitea.PaymentGateway.API.v1
{
    [Route("api/v1/[controller]")]
    [ApiController]
    public class AiteaNotifyController : ControllerBase
    {
        private readonly ILogger<PaymentController> _logger;
        private readonly IQfPayApiConnect _qfPayApiConnect;
        private readonly IMapper _mapper;
        public AiteaNotifyController(IQfPayApiConnect qfPayApiConnect, ILogger<PaymentController> logger, IMapper mapper)
        {
