...
using Aitea.PaymentGateway.Infrastructure.Extensions;
...
namespace Aitea.PaymentGateway
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<QfPayConfiguration>(Configuration.GetSection("QFPay"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Aitea.PaymentGateway ASP.NET Core API v1");
            });
